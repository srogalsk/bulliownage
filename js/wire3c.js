...
// API call to Quandl
var json_obj_daily=Get("https://www.quandl.com/api/v1/datasets/LPPM/PLAT.json?auth_token=F1s2QQVicUxmZi2jGRjz&trim_start=",1);
...
function handleData( csvdata ) {
    ...
    // 0 for platinum, 1 for silver, 2 for plat
...
$('#search').keyup(function() {
    var table = document.getElementById("platinum_table");
...
query.find({
  success: function(coins) {
    ...
    for (var i = 0; i < coins.length; i++) {
      ...
      var platinumperunit = Math.round((weight * percent) * 10000) / 10000;
      var ozt = Math.round((platinumperunit / (31.1034768)) * 10000) / 10000;
...
$("#platinum_table").on("click", ".no", function () {
