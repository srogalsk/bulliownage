...
function invalid() {
    ...
    document.getElementById("grams").innerHTML = invalid? "N/A" : unitgoldgrams;
    document.getElementById("ozt").innerHTML = invalid? "N/A" : unitgoldozt;
    document.getElementById("total").innerHTML = invalid? "N/A" : totalgoldozt;
    return invalid;
}
